  ...
  return (
    <div>
      <div className='font-sans work text-center my-[10px] mx-[15px] customMd:m-[100px]'>
        ...
        <div className="image1 flex flex-col justify-center items-center text-center text-customBlue  customMd:mt-[100px]">
        ...
        <div className="image2 flex flex-col justify-center items-center text-center text-customBlue customMd:mt-[100px]">
